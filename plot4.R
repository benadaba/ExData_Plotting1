...
par(mfrow = c(2,2))
#
with(hse_data_range, plot(datetime, Global_active_power, xlab = "",
                          ylab="Global Active Power", type="n"))
lines(hse_data_range$datetime, hse_data_range$Global_active_power )

#voltage
with(hse_data_range, plot(datetime, Voltage, type="n"))
lines(hse_data_range$datetime, hse_data_range$Voltage )
#
...
legend("topright", lty = 1, col = c("black","red", "blue"), 
       ...
       cex=0.25, text.font = 0.3 )

#global reactive power
with(hse_data_range, plot(datetime, Global_reactive_power, 
                          ylab="Global Reactive Power", type="n"))
lines(hse_data_range$datetime, hse_data_range$Global_reactive_power )


#copy to file PNG
dev.copy(png, file = file.path(getwd(),"Exploratory Data Analysis/ExData_Plotting1/plot4.png"), 
